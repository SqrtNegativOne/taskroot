...
export interface ICalendarAPI {
    ...
    createEvent(localEvent: AppEvent, ctx: { tasks: AppTask[], events: AppEvent[] }, calendarId?: string): Promise<{ remoteId: string, calendarId: string }>;
    updateEvent(remoteId: string, localEvent: AppEvent, updatedFields: (keyof AppEvent)[] | undefined, ctx: { tasks: AppTask[], events: AppEvent[] }, calendarId?: string): Promise<void>;
