...
export interface ICalendarAPI {
    ...
    updateEvent(googleId: string, localEvent: AppEvent, updatedFields: (keyof AppEvent)[] | undefined, ctx: { tasks: AppTask[], events: AppEvent[] }, calendarId?: string): Promise<void>;
